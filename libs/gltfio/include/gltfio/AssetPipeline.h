...
public:
    ...
    static const int BAKED_UV_ATTRIB_INDEX = 4;
     ...
     *
     * This invokes a embree-based pathtracer that operates on tiles of the target image. It spins
     * up a number of threads and triggers the progress callback every time a new tile has been
     * rendered.
     */
